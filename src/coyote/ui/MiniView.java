...
public class MiniView {
    ...
    public void miniView( QMainWindow miniview ) {
        ...
        // Icons
        QPixmap mplayPixmap = new QPixmap("classpath:/coyote/images/play.png");
        QPixmap mpausePixmap = new QPixmap("classpath:/coyote/images/pause.png");
        QPixmap mstopPixmap = new QPixmap("classpath:/coyote/images/stop.png");
        QPixmap mforwardPixmap = new QPixmap("classpath:/coyote/images/forward.png");
        QPixmap mbackPixmap = new QPixmap("classpath:/coyote/images/back.png");
        QPixmap mshufflePixmap = new QPixmap("classpath:/coyote/images/dice.png");
        QPixmap mreplayPixmap = new QPixmap("classpath:/coyote/images/replay_miniview.png");
        QPixmap mclear_playlistPixmap = new QPixmap("classpath:/coyote/images/clear_playlist.png");
        QPixmap micon = new QPixmap("classpath:/coyote/images/cover.png");
        QPixmap mplaylistPixmap = new QPixmap("classpath:/coyote/images/playlist_miniview.png");
        QPixmap closePixmap = new QPixmap("classpath:/coyote/images/miniview_close.png");
        QPixmap miniview_maximize = new QPixmap("classpath:/coyote/images/miniview_maximize.png");
        QPixmap mute = new QPixmap("classpath:/home/chris/.config/coyote/themes/light/icons/volume_off.png");
        QPixmap volume1 = new QPixmap("/home/chris/.config/coyote/themes/light/icons/volume_1line.png");
        QPixmap volume2 = new QPixmap("/home/chris/.config/coyote/themes/light/icons/volume_2lines.png");
        QPixmap volumefull = new QPixmap("classpath:/coyote.images/volume_full.png");
...
//        miniview.setStyleSheet(css.loadStyles("coyote/themes/miniview.css"));
