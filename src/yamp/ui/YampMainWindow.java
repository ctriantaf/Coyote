...
import yamp.YampLibrary;
import yamp.musiclibrary.Check_Files;
import yamp.musiclibrary.RestoreLibrary;
import yamp.ui.FindThemes;
import yamp.ui.SetThemes;
import yamp.musiclibrary.StoringFiles;


public class YampMainWindow extends StoringFiles {
    ...
    public void Yamp( QMainWindow yamp ) throws FileNotFoundException {   
...
//        infoButton.setIconSize(infoPixmap.rect().size());
        ...
        yamp.setCentralWidget(widget);
        yamp.setWindowState(Qt.WindowState.WindowMaximized);
    ...
    public static void main( String[] args ) throws IOException, FileNotFoundException, ClassNotFoundException {
        ...
        YampLibrary m = new YampLibrary();
        yamp = new QMainWindow();
        YampMainWindow window = new YampMainWindow();
        Check_Files checkF = new Check_Files();
        RestoreLibrary rLibrary = new RestoreLibrary();
        
        settings = new QSettings("", "Yamp");
